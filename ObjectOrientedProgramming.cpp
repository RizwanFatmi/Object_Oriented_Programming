...
// INHERITANCE:
class Charger : public AirPhones {
...
int main()
{
    ...
    system("cls");
        ...
        S1.Name = "Rizwan";
        S1.UserName = "RF2568";
        S1.SetPassword("Reez265");


        // CREATING OBJECTS USING CONSTRUCTOR:
        Mobile Oppo ("Oppo", "S11", 115, 35000.00);
        Mobile Nokia("Nokia", "Acess", 5233, 1299.00);
        Mobile Redmi("Redmi", "Note4", 256, 9999.00);
